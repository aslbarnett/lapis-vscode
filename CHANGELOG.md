...
- Fix Golang function keyword color.
...
- Fix click state on list view.

## "1.1.2"

- Add new images to readme.
- Fix color of selected file in Lapis Dark.
...
- Update color of Scala parameters.
...
- Update readme with terminal app port.
